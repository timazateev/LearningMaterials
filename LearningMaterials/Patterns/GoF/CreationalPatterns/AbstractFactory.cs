namespace LearningMaterials.Patterns.GoF.CreationalPatterns
{
    ...
    public class AbstractFactory
    {
        ...
        {
            // Abstract factory #1
            AbstractFactoryExample factory1 = new ConcreteFactory1();
            Client client1 = new Client(factory1);
            client1.Run();

            // Abstract factory #2
            AbstractFactoryExample factory2 = new ConcreteFactory2();
    ...
    /// </summary>
    abstract class AbstractFactoryExample
    {
    ...
    /// </summary>
    class ConcreteFactory1 : AbstractFactoryExample
    {
    ...
    /// </summary>
    class ConcreteFactory2 : AbstractFactoryExample
    {
        public override AbstractProductA CreateProductA()
        {
    ...
    class Client
    {
        ...
        // Constructor
        public Client(AbstractFactoryExample factory)
        {
